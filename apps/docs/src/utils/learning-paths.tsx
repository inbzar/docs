      ...
      },
      {
        ...
        descriptionJSX: (
          <>
            ...
            <Link to="/development/overview">InBzar development section</Link>.
          </>
        ),
      },
      {
    ...
    steps: [
      {
        ...
        descriptionJSX: (
          <>
            ...
            <ul>
              <li>
                <Link to="/medusa-react/overview">InBzar React</Link>: Can be
                used in any React-based project. For example, in a Next.js
                storefront.
              </li>
              <li>
                <Link to="/js-client/overview">InBzar JS Client</Link>: Can be
