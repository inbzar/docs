...
This document guides you through the different documentation resources that will help you build a B2B store with InBzar.
...
InBzar’s commerce features, including sales channels, customer groups, and price lists, facilitate implementing this setup. InBzar’s architecture and extendible nature allow you to customize your store based on your use case.
...
In InBzar, a sales channel allows you to set product availability per channel. In this case, you can create a B2B sales channel that will include only B2B products.

You can create a sales channel through the InBzar Admin or Admin REST APIs.

<DocCardList colSize={6} items={[
  {
    type: 'link',
    href: '/user-guide/sales-channels/manage',
    label: 'Option 1: Use InBzar Admin',
    customProps: {
      icon: Icons['users-solid'],
      description: 'Create the sales channel using the InBzar Admin.',
    }
  },
  {
    type: 'link',
...
You can create a publishable API key through the InBzar Admin or the Admin REST APIs, then associate it with the B2B sales channel. You’ll later use this key when developing your B2B storefront.
...
<DocCardList colSize={6} items={[
  {
    ...
    customProps: {
      icon: Icons['users-solid'],
      description: 'Create the publishable API key using the InBzar Admin.',
    }
  },
  {
    type: 'link',
...
Using the InBzar Admin or the Admin REST APIs, you can add your B2B products to your store. You can also import your products from an existing CSV file using the Product Import feature.
...
<DocCardList colSize={6} items={[
  {
    ...
    label: 'Add Products Using InBzar Admin',
    customProps: {
      icon: Icons['users-solid'],
      description: 'Create the product using the InBzar Admin.',
    }
  },
  {
    type: 'link',
  ...
  },
  {
    ...
    label: 'Import Products Using InBzar Admin',
    customProps: {
      icon: Icons['users-solid'],
      description: 'Import the products using the InBzar Admin.',
    }
  },
  {
    type: 'link',
...
<DocCardList colSize={6} items={[
  {
    ...
    customProps: {
      icon: Icons['users-solid'],
      description: 'Create the customer group using the InBzar Admin.',
    }
  },
  {
    type: 'link',
...
You can create a customer through the InBzar Admin or Admin REST APIs.
...
<DocCardList colSize={6} items={[
  {
    ...
    customProps: {
      icon: Icons['users-solid'],
      description: 'Create the customers using the InBzar Admin.',
    }
  },
  {
    type: 'link',
...
You can create a price list through the InBzar Admin or Admin REST APIs.

<DocCardList colSize={6} items={[
  {
    type: 'link',
    href: '/user-guide/price-lists/manage',
    label: 'Add Price List Using InBzar Admin',
    customProps: {
      icon: Icons['users-solid'],
      description: 'Create the price list using the InBzar Admin.',
    }
  },
  {
    type: 'link',
...
<DocCardList colSize={6} items={[
  ...
  },
  {
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Find all the development resources to customize InBzar.',
    }
  },
]} />
...
InBzar allows you to create custom API Routes exposed as REST APIs.
...
<DocCard item={{
  ...
  customProps: {
    icon: Icons['academic-cap-solid'],
    description: 'Learn how to create an API Route in InBzar.',
  }
}} />
...
Based on your use case, you may need to customize the InBzar Admin to add new widgets or pages.

The InBzar Admin plugin can be extended to add widgets, UI routes, and setting pages.
...
<DocCardList colSize={4} items={[
  ...
  },
  {
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Learn how to add new pages to your InBzar Admin.',
    }
  },
  {
    type: 'link',
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Learn how to add new page to the InBzar Admin settings.',
    }
  },
]} />
...
InBzar provides a Next.js starter that you can use and customize. You can also build your storefront with any frontend technology. InBzar provides you with different client libraries and REST APIs to use.
...
<DocCardList colSize={6} items={[
  {
    ...
    label: 'Deploy InBzar Backend',
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Learn how to deploy your InBzar backend to your preferred hosting provider.',
    }
  },
  {
    type: 'link',
...
You can find other resources for your B2B development in the [InBzar Development section](../development/overview.mdx) of this documentation.
