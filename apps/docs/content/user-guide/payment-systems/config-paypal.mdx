...
Go to region settings and enable PayPal payment provider, By default only manual payment is enabled in your region. Check [user guide how to manage payment provider](/user-guide/regions/providers#manage-payment-providers)