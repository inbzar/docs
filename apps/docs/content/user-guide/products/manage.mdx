---
sidebar_position: 2
description: 'This user guide explains how to manage products on the InBzar Admin. Learn how to create a product, edit a product, and more.'
addHowToData: true
---
...
4. Tags are comma-separated. After entering a tag’s value, add a comma “,” and it will create the tag. You can remove the tag by pressing the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999180/InBzar%20Docs/UI%20Icons/kvGRHQR_s0ptsm.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999200/InBzar%20Docs/UI%20Icons/RJ4SLIu_n30zqr.png" alt="X" /> icon next to it.
...
1. Add a new option by clicking the “Add an option” button.
    1. This shows two new fields: the Title and the Variations fields. Separate the variations using a comma “,”. You can remove a variation by clicking the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999180/InBzar%20Docs/UI%20Icons/kvGRHQR_s0ptsm.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999200/InBzar%20Docs/UI%20Icons/RJ4SLIu_n30zqr.png" alt="X" /> icon next to it.
    2. To remove an option, click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999273/InBzar%20Docs/UI%20Icons/7hztVhj_mj6mxu.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999290/InBzar%20Docs/UI%20Icons/1yp4PNt_vzwnhf.png" alt="trash" /> icon next to it.
2. Add a new variant by clicking the “Add a variant” button. In the new window that opens:
    ...
    2. In the Stock & Inventory section, you can manage how InBzar handles the product’s inventory, the quantity in stock, and more.
        1. If Manage Inventory is enabled, InBzar will change the available quantity of the variant when orders or returns are made.
...
3. You can edit a variant by clicking the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/InBzar%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/InBzar%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> icon, then choosing Edit from the dropdown.
4. You can delete a variant by clicking the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/InBzar%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/InBzar%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> icon, then choosing Delete from the dropdown.
...
2. To delete a thumbnail:
    1. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/InBzar%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/InBzar%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> icon.
...
2. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/InBzar%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/InBzar%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> at the top right of the first section.
...
1. Go to the product’s details page.
2. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/InBzar%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/InBzar%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> icon in the top right of the Variants section.
...
4. In the new window that opens:
    ...
    3. You can delete an option by clicking the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999273/InBzar%20Docs/UI%20Icons/7hztVhj_mj6mxu.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999290/InBzar%20Docs/UI%20Icons/1yp4PNt_vzwnhf.png" alt="trash" /> icon.
...
4. In the window that opens:
    ...
    3. In the Stock & Inventory section, you can manage how InBzar handles the product’s inventory, the quantity in Stock, and more.
        1. If you disable the Manage Inventory field, InBzar will assume the product is always in stock.
...
4. In the window that opens:
    1. Click and hold the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999654/InBzar%20Docs/UI%20Icons/zp2QTbO_io0f7i.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999668/InBzar%20Docs/UI%20Icons/ZPpOcvi_h14vyz.png" alt="grip" /> icon next to the variant, then drag it to the position you want.
...
3. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/InBzar%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/InBzar%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> icon.
...
1. Go to the product's details page.
2. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/InBzar%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/InBzar%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> icon at the top right of the Variants section.
...
1. Either press <kbd>esc</kbd> or click the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999180/InBzar%20Docs/UI%20Icons/kvGRHQR_s0ptsm.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999200/InBzar%20Docs/UI%20Icons/RJ4SLIu_n30zqr.png" alt="X" /> icon at the top left.
...
1. Go to the product’s details page.
2. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/InBzar%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/InBzar%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> icon in the top right of the Attributes section.
...
1. Go to the product’s details page.
2. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999273/InBzar%20Docs/UI%20Icons/7hztVhj_mj6mxu.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999290/InBzar%20Docs/UI%20Icons/1yp4PNt_vzwnhf.png" alt="trash" /> icon at the top right of the Thumbnail section.
...
1. Go to the Products page.
2. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/InBzar%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/InBzar%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> icon next to the product you want to duplicate.
...
1. Go to the Products page.
2. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/InBzar%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/InBzar%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> icon next to the product you want to delete.
