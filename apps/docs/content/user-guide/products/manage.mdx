...
If product is digital product or service then make sure you enable the 'Digital or Service' checkbox.

:::

### Subscription Section

Learn how to create and manage subscriptions for products. Check [Manage Subscription Guide](manage-subscriptions) to learn more.

### Organize Section

:::note

If you don't see a categories field, it's because this feature is currently in beta and once available we let you know.
