---
sidebar_position: 3
description: 'This user guide explains how to manage categories on the InBzar Admin. Learn how to create a category, edit existing categories, delete a category, and more.'
addHowToData: true
---
...
1. Go to the Categories page.
2. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999131/InBzar%20Docs/UI%20Icons/1hL8NiW_lqmjcq.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999150/InBzar%20Docs/UI%20Icons/8LtkPqW_jyqz5i.png" alt="plus" /> icon at the right of the category you’re adding the new category inside.
...
1. Go to the Categories page.
2. Click and hold the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999654/InBzar%20Docs/UI%20Icons/zp2QTbO_io0f7i.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999668/InBzar%20Docs/UI%20Icons/ZPpOcvi_h14vyz.png" alt="grip" /> icon next to the category you want to move. Keep holding the icon until step four.
...
4. Once you move it to the new destination, release the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999654/InBzar%20Docs/UI%20Icons/zp2QTbO_io0f7i.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999668/InBzar%20Docs/UI%20Icons/ZPpOcvi_h14vyz.png" alt="grip" /> icon.
...
1. Go to the Categories page.
2. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/InBzar%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/InBzar%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> icon at the right of the category.
