---
sidebar_position: 6
description: 'This user guide explains how to manage draft orders on the InBzar Admin. Learn how to create a draft order, view its details, edit a draft order, cancel a draft order, and more.'
addHowToData: true
---
...
Draft orders are orders created from the InBzar Admin. Existing products or custom items can be added to the order as purchased items. You can also specify custom shipping amounts.
