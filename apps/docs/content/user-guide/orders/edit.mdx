---
sidebar_position: 5
description: 'This user guide explains how to edit the items in an order in the InBzar Admin. You can add, update, replace, duplicate, and delete items.'
addHowToData: true
---
...
Using the InBzar Admin, you can edit the items in an order. You can perform the following edits:
...
3. In the new window that opens:
    ...
    2. To update an item’s quantity:
        1. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999131/InBzar%20Docs/UI%20Icons/1hL8NiW_lqmjcq.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999150/InBzar%20Docs/UI%20Icons/8LtkPqW_jyqz5i.png" alt="plus" /> or <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999351/InBzar%20Docs/UI%20Icons/EGk9uYD_a7rwhs.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999366/InBzar%20Docs/UI%20Icons/XvkBK8p_dzhzfx.png" alt="minus" /> icons next to the quantity of the item you want to edit.
    3. To replace an item:
        1. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/InBzar%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/InBzar%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> icon next to the item.
