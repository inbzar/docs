...
description: 'This user guide explains how to manage order returns on the InBzar Admin. Learn how to request a return for an order, mark a return as received, and cancel a return.'
addHowToData: true
---
...
Part of the order management system that InBzar provides is automating and managing order returns.
