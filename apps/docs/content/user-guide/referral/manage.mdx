---
sidebar_position: 3
description: 'This user guide explains how to manage referrals on the InBzar Admin. Learn how to edit and delete referrals'
addHowToData: true
---
...
In this document, you’ll learn how to manage referrals including editing and deleting a referral.

## View Referral Details

To view a referral’s details:

1. Go to Referral.
2. Click on the referral you want to view its details

This opens the referral’s details page.
...
Changing a referral’s status to published makes it available for customers to use. Changing a referral’s status to draft makes it unavailable for customers to use.

:::

To change a referral’s status:

1. Go to the referral details page.
2. At the top right of the first section, you’ll see the status of the referral (for example, Published). Click on it.
3. Choose from the dropdown the opposite status (for example, Draft)

### Edit General Information

To edit a referral’s general information:
...
4. In the pop-up, you can edit any of the referral information.
5. Once done, click on the "Save and close" button.

---

## Manage Referral Configurations

### Edit Configurations

To edit a referral’s configuration:
...
To add a condition to a referral:
...
To edit a referral’s condition:
...
To delete a referral’s condition:
...
Deleting a referral can't be undone.
...
1. Go to the referral details page.
2. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/Medusa%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/Medusa%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> icon at the top right of the first section.
3. Click on “Delete referral” from the dropdown.
4. Confirm deleting the referral by clicking the “Yes, confirm” button in the pop-up.
