---
sidebar_position: 3
description: 'This user guide explains how to manage return reasons on the InBzar Admin. Learn how to add, edit, and remove return reasons.'
addHowToData: true
---
