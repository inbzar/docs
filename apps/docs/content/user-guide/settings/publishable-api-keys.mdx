---
sidebar_position: 4
description: 'This user guide explains how to manage publishable API keys on the InBzar Admin. Learn how to create, edit, copy, and revoke publishable API keys.'
addHowToData: true
---
...
In this document, you’ll learn how to manage publishable API keys in InBzar Admin.
