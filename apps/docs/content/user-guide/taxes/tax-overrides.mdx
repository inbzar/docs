---
sidebar_position: 4
description: 'This user guide explains how to manage tax overrides on the InBzar Admin. Learn how to add, edit, and delete overrides.'
addHowToData: true
---
...
In this document, you’ll learn how to manage tax overrides in your InBzar Admin.
...
5. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/InBzar%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/InBzar%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> icon next to the override type.
