---
sidebar_position: 5
description: 'This user guide explains how to manage tax inclusive pricing on the InBzar Admin.'
addHowToData: true
---
...
Tax-inclusive pricing saves you the manual work. When tax-inclusive pricing is enabled, you can just enter the price you want the customer to see on the storefront. InBzar then takes care of calculating the tax amount applied to the item based on the tax rate.
...
3. In the first section on the right, click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/InBzar%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/InBzar%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> icon.
...
1. Go to Settings → Regions.
2. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999131/InBzar%20Docs/UI%20Icons/1hL8NiW_lqmjcq.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999150/InBzar%20Docs/UI%20Icons/8LtkPqW_jyqz5i.png" alt="plus" /> icon at the top right of the Regions section.
...
3. Click on the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999308/InBzar%20Docs/UI%20Icons/1ordBC6_ssysel.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1667999326/InBzar%20Docs/UI%20Icons/dSwWYBH_stzgoi.png" alt="three dots" /> icon at the top right of the first section.
...
When specifying the price of a product for a currency or a region, the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1668071655/InBzar%20Docs/UI%20Icons/taxes_hoogia.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1668071655/InBzar%20Docs/UI%20Icons/taxes-dark_mwu0us.png" alt="tax-inclusive" /> icon will be greyed out if it’s disabled for that currency/region. If it’s enabled, the icon will be colored.
