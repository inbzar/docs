---
description: "Learn how to use the bulk editor in the InBzar Admin and its shortcuts. The bulk editor is available in different areas, including the product details page and the Create Price List form."
---
...
The bulk editor is used in different areas of the InBzar Admin, including the [Edit Product Prices](../products/manage.mdx#edit-product-prices) form or the [Create Price List](../price-lists/manage.mdx#step-3-edit-prices) form.
