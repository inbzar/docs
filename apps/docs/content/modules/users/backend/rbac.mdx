...
In this document, you'll get a high-level overview of how you can implement role-based access control (RBAC) in your InBzar backend.
...
This guide gives you a high-level approach to implementing RBAC in InBzar. The examples included in this guide provide a simple implementation to give you an idea of how you can implement this functionality in your InBzar backend.
...
Since the InBzar backend uses Express, you can create a middleware and attach it to all admin routes.
...
<DocCard item={{
  ...
  customProps: {
    icon: Icons['academic-cap-solid'],
    description: 'Learn how to create a middleware in InBzar.',
  }
}} />
...
<DocCardList colSize={4} items={[
  ...
  },
  {
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Learn how to extend a core service in InBzar',
    }
  },
]} />
...
<Details>
  ...
  To test the API Routes out, run the `build` command in the root directory of your InBzar backend project:
...
If your use case requires other changes or functionality implementations, check out the [InBzar Development section](../../../development/overview.mdx) of the documentation for all available development guides.
