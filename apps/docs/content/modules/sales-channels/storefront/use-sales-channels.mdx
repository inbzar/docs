...
- Managing publishable API keys using [admin APIs](../../../development/publishable-api-keys/admin/manage-publishable-api-keys.mdx) or using [InBzar Admin](../../../user-guide/settings/publishable-api-keys.mdx)
