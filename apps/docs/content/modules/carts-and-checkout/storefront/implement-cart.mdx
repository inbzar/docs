...
This document helps you understand how to add the cart functionality to your storefront. This is helpful if you’re creating the storefront from scratch, or you want to understand how the process generally works in InBzar’s starter storefronts.
...
<Tabs groupId="request-type" isCodeTabs={true}>
  ...
  <TabItem value="medusa-react" label="InBzar React" default>
