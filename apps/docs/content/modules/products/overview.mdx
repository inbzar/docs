...
Looking guide? Check out the [Products user guide](../../user-guide/products/manage.mdx).
...
<DocCardList colSize={4} items={[
  {
    ...
    customProps: {
      ...
      description: 'Manage products in InBzar Admin.'
    }
  }
]} />
...
<DocCardList colSize={4} items={[
  {
    ...
    customProps: {
      icon: Icons['users-solid'],
      description: 'Learn how to manage categories in the InBzar Admin.'
    }
  },
]} />
...
Admins can bulk import and export products using CSV files. This facilitates moving data from other ecommerce platforms to InBzar.
...
<DocCardList colSize={4} items={[
  {
    ...
    customProps: {
      icon: Icons['users-solid'],
      description: 'Learn how to import products into InBzar Admin.'
    }
  },
  {
    type: 'link',
    ...
    customProps: {
      icon: Icons['users-solid'],
      description: 'Learn how to export products from InBzar Admin.'
    }
  },
]} />
...
Discover Products’ relation to other features in InBzar
