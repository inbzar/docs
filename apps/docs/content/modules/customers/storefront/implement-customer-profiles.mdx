...
InBzar provides the necessary functionalities and API Routes to allow integrating essential customer features. Customers can create accounts to manage their information and keep track of their orders.
...
You can use InBzar’s Store APIs to achieve more functionalities as well. Check out the [API reference](https://docs.medusajs.com/api/store#customers) to learn more.
...
If you’re using the InBzar JS Client, the customer’s session will already be set and used in all future requests.
