...
InBzar then takes care of the calculation of subtotals, taxes, and more.
...
![Order edit flow](https://res.cloudinary.com/dza7lstvk/image/upload/v1677782269/InBzar%20Docs/Diagrams/order-edit_mcnfc3.jpg)
...
It is assumed that you already have a InBzar backend installed and set up. If not, you can follow our [quickstart guide](../../../development/backend/install.mdx) to get started.
