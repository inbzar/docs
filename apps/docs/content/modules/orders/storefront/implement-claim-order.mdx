...
This flow was added starting from InBzar v1.7. You can learn more about upgrading in the [upgrade guide](../../../upgrade-guides/medusa-core/1-7-0.md).
...
![Claim Order Flow](https://res.cloudinary.com/dza7lstvk/image/upload/v1677782439/InBzar%20Docs/Diagrams/claim-order-workflow_m6oybo.jpg)
