...
This guide assumes you have the Inventory Module installed on your InBzar backend. If not, you can learn how to install it using [this guide](../install-modules.md#inventory-module).
