...
This guide assumes you have a stock location module installed. You can use InBzar’s [Stock Location module](../install-modules.md#stock-location-module) or [create your own module](../backend/create-stock-location-service.md).
