...
Multi-warehouse in InBzar is composed of two modules: an inventory module - which is the NPM package `@medusajs/inventory` - and a stock location module - which is the NPM package `@medusajs/stock-location`.
...
You can also create your own modules and use them with the InBzar backend.
...
Discover Multi-warehouse’s relation to other modules in InBzar.
