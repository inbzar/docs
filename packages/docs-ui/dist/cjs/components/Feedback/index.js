            ...
            react_1.default.createElement(react_transition_group_1.CSSTransition, { key: showForm
                ...
                react_1.default.createElement(react_1.default.Fragment, null,
                    !showForm && !submittedFeedback && (react_1.default.createElement("div", { className: (0, clsx_1.default)("flex", !vertical && "flex-row items-center", vertical && "flex-col justify-center gap-docs_1"), ref: inlineFeedbackRef },
                        react_1.default.createElement(components_1.Label, { className: "mr-docs_1.5" }, question),
                        react_1.default.createElement("div", { className: (0, clsx_1.default)("flex flex-row items-center gap-docs_0.5") },
                            react_1.default.createElement(components_1.Button, { onClick: handleFeedback, className: "positive w-fit", variant: "secondary" }, positiveBtn),
                            react_1.default.createElement(components_1.Button, { onClick: handleFeedback, className: "w-fit", variant: "secondary" }, negativeBtn),
                            reportLink && (react_1.default.createElement(components_1.Button, { variant: "secondary" },
                    ...
                    showForm && !submittedFeedback && (react_1.default.createElement("div", { className: "flex flex-col gap-docs_1", ref: inlineQuestionRef },
                        ...
                        react_1.default.createElement(components_1.TextArea, { rows: 4, value: message, onChange: (e) => setMessage(e.target.value) }),
                        showLongForm && !positiveFeedback && (react_1.default.createElement(components_1.Details, { summaryContent: "More Details", className: "mt-docs_1" },
                            react_1.default.createElement("div", { className: "flex flex-col gap-docs_0.5" },
                                ...
                                react_1.default.createElement("div", { className: "flex flex-col gap-docs_0.5" },
                                    ...
                                    react_1.default.createElement(components_1.TextArea, { rows: 4, value: errorFix, onChange: (e) => setErrorFix(e.target.value), placeholder: "@medusajs/medusa: vX" })),
                                react_1.default.createElement("div", { className: "flex flex-col gap-docs_0.5" },
                                    react_1.default.createElement(components_1.Label, null, "Can you provide your email or discord username? This would allow us to contact you for further info or assist you with your issue."),
                                    react_1.default.createElement(components_1.InputText, { value: contactInfo, onChange: (e) => setContactInfo(e.target.value), placeholder: "user@example.com" }))))),
                        react_1.default.createElement(components_1.Button, { onClick: submitFeedback, disabled: loading, className: "w-fit", variant: "secondary" }, submitBtn))),
