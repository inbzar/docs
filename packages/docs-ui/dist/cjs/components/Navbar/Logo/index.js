...
const NavbarLogo = ({ light, dark, className, imageClassName, }) => {
    ...
    return (react_1.default.createElement(link_1.default, { href: `/`, className: (0, clsx_1.default)("flex-1", className) },
        react_1.default.createElement("img", { src: colorMode === "light" ? light : dark || light, alt: "InBzar Logo", height: 20, width: 20, className: (0, clsx_1.default)("align-middle", imageClassName) })));
};
