...
const IconCircleDottedLine = (props) => {
    return (react_1.default.createElement("svg", Object.assign({ width: props.width || 20, height: props.height || 20, viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props, { className: (0, clsx_1.default)("text-ui-fg-subtle", props.className) }),
