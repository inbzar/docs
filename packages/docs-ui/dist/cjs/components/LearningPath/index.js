...
const LearningPath = ({ pathName, className = "", }) => {
    ...
    return (react_1.default.createElement("div", { className: (0, clsx_1.default)("rounded shadow-card-rest dark:shadow-card-rest-dark bg-docs-bg-surface mt-docs_1.5 mb-docs_4", className) },
