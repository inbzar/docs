...
const LearningPathIcon = ({ className = "", imgClassName = "", }) => {
    ...
    return (react_1.default.createElement("div", { className: (0, clsx_1.default)("rounded-full shadow-card-rest dark:shadow-card-rest-dark w-docs_3 h-docs_3 bg-medusa-bg-base", "flex justify-center items-center flex-none", className) },
