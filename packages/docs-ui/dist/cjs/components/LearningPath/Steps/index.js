    ...
    return (react_1.default.createElement(react_transition_group_1.SwitchTransition, null,
        react_1.default.createElement(react_transition_group_1.CSSTransition, { key: collapsed ? "show_path" : "show_button", nodeRef: nodeRef, timeout: 300, addEndListener: (done) => {
            ...
            react_1.default.createElement(react_1.default.Fragment, null,
                !collapsed && (react_1.default.createElement("div", { className: (0, clsx_1.default)("bg-medusa-bg-base shadow-flyout dark:shadow-flyout-dark rounded", "transition-transform origin-bottom-right flex flex-col"), ref: stepsRef },
                    react_1.default.createElement("div", { className: "overflow-auto basis-3/4" }, path.steps.map((step, index) => {
                        var _a;
                        return (react_1.default.createElement("div", { className: (0, clsx_1.default)("border-0 border-b border-solid border-medusa-border-base", "relative p-docs_1"), key: index },
                            ...
                            index === currentStep && (react_1.default.createElement("div", { className: (0, clsx_1.default)("flex items-center gap-docs_1") },
                                ...
                                react_1.default.createElement("div", { className: (0, clsx_1.default)("text-medium text-ui-fg-subtle mt-docs_1") }, (_a = step.descriptionJSX) !== null && _a !== void 0 ? _a : step.description)))));
                    })),
                    react_1.default.createElement(Actions_1.LearningPathStepActions, Object.assign({ setCollapsed: setCollapsed }, rest)))),
                collapsed && (react_1.default.createElement(components_1.Button, { variant: "secondary", className: (0, clsx_1.default)("!p-[10px] !shadow-flyout dark:!shadow-flyout-dark !text-medusa-fg-subtle w-fit h-fit", "rounded-full border-0 mr-0 ml-auto fixed md:relative max-[767px]:bottom-docs_1 max-[767px]:right-docs_1 "), onClick: () => setCollapsed(false), buttonRef: buttonRef },
