...
const paths = [
        ...
        steps: [
            {
                ...
                description: "Create a Next.js Starter Template and connect it to your InBzar backend.",
                path: "#",
            },
            {
    ...
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                descriptionJSX: (React.createElement(React.Fragment, null,
                    "Add a payment provider to your InBzar backend. You can choose to install a plugin or",
                    " ",
        ...
        steps: [
            ...
            },
            {
                ...
                descriptionJSX: (React.createElement(React.Fragment, null,
                    ...
                    ", and handles creating the subscription in InBzar.")),
                path: "/development/events/create-subscriber",
            },
            {
    ...
    },
    {
        ...
        description: "Utilize InBzar's features and customization capabilities to build a B2B store.",
        steps: [
            {
            ...
            },
            {
                ...
                descriptionJSX: (React.createElement(React.Fragment, null,
                    ...
                    React.createElement("br", null),
                    "You can use the InBzar admin to add the products. Other alternatives are:",
                    React.createElement("ul", null,
                        React.createElement("li", null,
                            React.createElement(Link, { href: "/modules/products/admin/manage-products" }, "Add Products Using REST APIs")),
                        React.createElement("li", null,
                            React.createElement(Link, { href: "/user-guide/products/import" }, "Import Products Using InBzar Admin")),
                        React.createElement("li", null,
            ...
            },
            {
                ...
                descriptionJSX: (React.createElement(React.Fragment, null,
                    ...
                    React.createElement("br", null),
                    "You can use the InBzar admin to add the price list. Other alternatives are:",
                    React.createElement("ul", null,
                        React.createElement("li", null,
                            React.createElement(Link, { href: "/modules/price-lists/admin/manage-price-lists" }, "Add Price List Using REST APIs")),
                        React.createElement("li", null,
                            React.createElement(Link, { href: "/user-guide/price-lists/import" }, "Import Prices Using InBzar Admin")),
                        React.createElement("li", null,
            ...
            },
            {
                ...
                descriptionJSX: (React.createElement(React.Fragment, null,
                    ...
                    React.createElement("br", null),
                    "InBzar can be customized to add custom entities, API Routes, services, and more.",
                    React.createElement("br", null),
                    "You can find additional development resources in the",
                    " ",
                    React.createElement(Link, { href: "/development/overview" }, "InBzar development section"),
                    ".")),
            },
            {
    ...
    },
    {
        ...
        description: "Use InBzar’s architecture and functionalities to integrate third-party systems and build flows around them.",
        steps: [
            {
                title: "Connect to External Systems with Services",
                path: "/development/services/create-service",
                descriptionJSX: (React.createElement(React.Fragment, null,
                    "InBzar\u2019s Services let you implement a client that connects and performs functionalities with your third-party system.",
                    React.createElement("br", null),
                    React.createElement("br", null),
            ...
            },
            {
                ...
                descriptionJSX: (React.createElement(React.Fragment, null,
                    "With InBzar\u2019s workflows, you can build flows with steps that may perform actions on different systems. Workflows can be executed from anywhere.",
                    React.createElement("br", null),
                    React.createElement("br", null),
        ...
        steps: [
            {
                ...
                descriptionJSX: (React.createElement(React.Fragment, null,
                    "As your storefront connect to the InBzar backend, you need a way to interact with the backend's REST APIs. There are three ways to do so, based on your type of project:",
                    React.createElement("ul", null,
                        React.createElement("li", null,
                            React.createElement(Link, { href: "/medusa-react/overview" }, "InBzar React"),
                            ": Can be used in any React-based project. For example, in a Next.js storefront."),
                        React.createElement("li", null,
                            React.createElement(Link, { href: "/js-client/overview" }, "InBzar JS Client"),
                        ...
                        React.createElement("li", null,
                            ...
                            ": You can send requests directly to the API Routes without using InBzar's clients.")))),
            },
            {
    ...
    },
    {
        ...
        description: "Learn how to create a plugin that can be re-used across InBzar backends.",
        steps: [
            {
                title: "Setup plugin project",
                path: "/development/backend/install",
                description: "A plugin is initially a InBzar backend with customizations. If you don't have a project ready, you can create one using InBzar's CLI tool.",
            },
            {
            ...
            },
            {
                ...
                description: "If necessary, you can test your plugin in a separate local InBzar backend. It's recommended, however, to do your plugin testing within the plugin project.",
            },
            {
